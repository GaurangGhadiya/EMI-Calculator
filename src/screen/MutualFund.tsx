...
import MFData from '../data/MF';
  ...
  const MutualFund = () => {
    ...
    const calculate = () => {
      ...
      const totalInvestment = parseFloat(data.investment);
      const annualInterestRate =parseFloat(data.intrest) / 100;
      const finalAmount = (totalInvestment * Math.pow((1 + annualInterestRate), parseFloat(time))) - parseFloat(data.investment);
  
      setdata({
        ...data,
        amount: data.investment,
        return: Math.round(finalAmount) ,
        total: data.investment + (Math.round(finalAmount) ),
      });
    };
    return (
            ...
            <View style={styles.outer}>
              ...
              <View
                ...
                <TextInput
                  ...
                  onChangeText={value =>
                    handleChange('intrest', parseInt(value) > 50 ? 50 : value)
                  }
                />
                <Text
                  style={[
            ...
            <View style={styles.outer}>
              ...
              <View
                ...
                <TextInput
                  ...
                  onChangeText={value =>
                    handleChange('time', parseInt(value) > 40 ? 40 : value)
                  }
                />
                <Text
                  style={[
